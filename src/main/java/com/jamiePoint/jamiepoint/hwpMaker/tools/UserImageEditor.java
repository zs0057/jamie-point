...
public class UserImageEditor {
	public static void UserImageToHwp(ControlTable curCtr, HWPFile hwpFile, UserInfoForm userInfoForm) {

        Row seventhRow = curCtr.getRowList().get(3);
        Cell seventhCell = seventhRow.getCellList().get(0);
        String idCardImgPath = "basic_hwp" + File.separator + "image" + File.separator + "IdCard.jpg";
        userInfoForm.makeImage(userInfoForm.getIdCardImg(), idCardImgPath);
        
        Row eightRow = curCtr.getRowList().get(5);
        Cell eightCell = eightRow.getCellList().get(0);
        String bankImgPath = "basic_hwp" + File.separator + "image" + File.separator + "bank.jpg";
        userInfoForm.makeImage(userInfoForm.getBankBookImg(), bankImgPath);
        
        InsertImage(seventhCell, idCardImgPath, hwpFile);
        InsertImage(eightCell, bankImgPath, hwpFile);
